...
use raphtory::{
    algorithms::{
        ...
        centrality::{
            ...
            hits::hits, new_unweighted_pagerank::unweighted_page_rank as new_unweighted_page_rank,
            pagerank::page_rank, unweighted_pagerank::unweighted_page_rank,
        },
        community_detection::{
...
fn large_random_attachment_subgraph_cache_view() -> impl StaticGraphViewOps {
    let subgraph = large_random_attachment_subgraph();
    subgraph.cache_view()
}

fn large_weighted_random_attachment_subgraph_cache_view() -> impl StaticGraphViewOps {
    let subgraph = large_weighted_random_attachment_subgraph();
    subgraph.cache_view()
}

fn large_typed_random_attachment_subgraph_cache_view() -> impl StaticGraphViewOps {
    let subgraph = large_typed_random_attachment_subgraph();
    subgraph.cache_view()
}
...
pub fn local_triangle_count_analysis(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "local_triangle_count_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
        |graph, node_id| local_triangle_count(graph, node_id.clone()).unwrap(),
    );
    graph_benchmark_with_setup(
...
pub fn local_clustering_coefficient_analysis(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "local_clustering_coefficient_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_clustering_coeff(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_clustering_coeff_subgraph_cache_view",
        60,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| global_clustering_coefficient(graph),
...
pub fn graphgen_large_pagerank(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_pagerank_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| page_rank(graph, None, Some(100), None, None, true, None),
...
pub fn graphgen_large_unweighted_pagerank(c: &mut Criterion) {
    graph_benchmark(
        c,
        "graphgen_large_unweighted_pagerank",
        20,
        10,
        large_random_attachment_graph,
        |graph, _| unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    );
    graph_benchmark(
        c,
        "graphgen_large_unweighted_pagerank_subgraph",
        20,
        10,
        large_random_attachment_subgraph,
        |graph, _| unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    ...
    graph_benchmark(
        c,
        "graphgen_large_unweighted_pagerank_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    ...
    graph_benchmark(
        c,
        "graphgen_large_unweighted_pagerank_layered",
        20,
        10,
        large_random_attachment_layered,
        |graph, _| unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
...
pub fn graphgen_large_new_unweighted_pagerank(c: &mut Criterion) {
    graph_benchmark(
        c,
        "graphgen_large_new_unweighted_pagerank",
        20,
        10,
        large_random_attachment_graph,
        |graph, _| new_unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    );
    graph_benchmark(
        c,
        "graphgen_large_new_unweighted_pagerank_subgraph",
        20,
        10,
        large_random_attachment_subgraph,
        |graph, _| new_unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    ...
    graph_benchmark(
        c,
        "graphgen_large_new_unweighted_pagerank_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| new_unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
    ...
    graph_benchmark(
        c,
        "graphgen_large_new_unweighted_pagerank_layered",
        20,
        10,
        large_random_attachment_layered,
        |graph, _| new_unweighted_page_rank(graph, Some(100), None, None, true, None).len(),
...
pub fn graphgen_large_concomp(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_concomp_subgraph_cache_view",
        60,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| weakly_connected_components(graph),
...
pub fn graphgen_large_hits(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_hits_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| hits(graph, 100, None),
...
pub fn graphgen_large_degree_centrality(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_degree_centrality_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| degree_centrality(graph),
...
pub fn graphgen_large_betweenness(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_betweenness_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| betweenness_centrality(graph, None, false),
...
pub fn graphgen_large_triangle_count(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_triangle_count_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| triangle_count(graph, None),
...
pub fn graphgen_large_triplet_count(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_triplet_count_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| triplet_count(graph, None),
...
pub fn graphgen_large_directed_density(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_directed_density_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| directed_graph_density(graph),
...
pub fn graphgen_large_reciprocity(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_reciprocity_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| global_reciprocity(graph),
...
pub fn graphgen_large_scc(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_scc_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| strongly_connected_components(graph),
...
pub fn graphgen_large_in_components(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_in_components_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| in_components(graph, None),
...
pub fn graphgen_large_out_components(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_out_components_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| out_components(graph, None),
...
pub fn graphgen_large_in_components_filtered(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_in_components_filtered_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| in_components_filtered(graph, None, Unfiltered).unwrap(),
...
pub fn graphgen_large_out_components_filtered(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_out_components_filtered_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| out_components_filtered(graph, None, Unfiltered).unwrap(),
...
pub fn graphgen_large_label_propagation(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_label_propagation_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| label_propagation(graph, 20, Some([1; 32]), None),
...
pub fn graphgen_large_louvain(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_louvain_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| louvain::<ModularityUnDir, _>(graph, 1.0, None, None),
...
pub fn graphgen_large_alternating_mask(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_alternating_mask_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| alternating_mask(graph),
...
pub fn graphgen_large_all_local_reciprocity(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_all_local_reciprocity_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| all_local_reciprocity(graph),
...
pub fn graphgen_large_balance(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_balance_subgraph_cache_view",
        20,
        10,
        large_weighted_random_attachment_subgraph_cache_view,
        |graph, _| balance(graph, "weight".to_string(), Direction::BOTH).unwrap(),
    );
    graph_benchmark(
        c,
...
pub fn graphgen_large_max_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_max_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| max_degree(graph),
...
pub fn graphgen_large_min_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_min_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| min_degree(graph),
...
pub fn graphgen_large_max_out_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_max_out_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| max_out_degree(graph),
...
pub fn graphgen_large_max_in_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_max_in_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| max_in_degree(graph),
...
pub fn graphgen_large_min_out_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_min_out_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| min_out_degree(graph),
...
pub fn graphgen_large_min_in_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_min_in_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| min_in_degree(graph),
...
pub fn graphgen_large_average_degree(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_average_degree_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| average_degree(graph),
...
pub fn graphgen_large_local_clustering_coefficient_batch(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_local_clustering_coefficient_batch_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_temporal_rich_club(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_temporal_rich_club_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| {
...
pub fn graphgen_large_temporal_motif_multi(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_temporal_motif_multi_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| temporal_three_node_motif_multi(graph, vec![100], None),
...
pub fn graphgen_large_local_temporal_motif(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_local_temporal_motif_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| local_temporal_three_node_motif(graph, 100, None),
...
pub fn graphgen_large_dijkstra(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_dijkstra_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_single_source_shortest_path(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_single_source_shortest_path_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_temporally_reachable_nodes(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_temporally_reachable_nodes_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_in_component(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_in_component_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_out_component(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_out_component_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_in_component_filtered(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_in_component_filtered_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_large_out_component_filtered(c: &mut Criterion) {
    ...
    graph_benchmark_with_setup(
        c,
        "graphgen_large_out_component_filtered_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        first_node_id,
...
pub fn graphgen_internal_global_triangle_motifs(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_internal_global_triangle_motifs_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| global_triangle_motifs_internal(graph, vec![100], None),
...
pub fn graphgen_internal_local_triangle_motifs(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_internal_local_triangle_motifs_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| local_triangle_motifs_internal(graph, vec![100], None),
...
pub fn graphgen_large_k_core_set(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_k_core_set_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| k_core_set(graph, 2, usize::MAX, None),
...
pub fn graphgen_large_k_core(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_k_core_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| k_core(graph, 2, usize::MAX, None),
...
pub fn graphgen_large_fruchterman_reingold(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_fruchterman_reingold_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| fruchterman_reingold_unbounded(graph, 5, 1.0, 1.0, 0.9, 0.1),
...
pub fn graphgen_large_cohesive_fruchterman_reingold(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_cohesive_fruchterman_reingold_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| cohesive_fruchterman_reingold(graph, 5, 1.0, 1.0, 0.9, 0.1),
...
pub fn graphgen_large_fast_rp(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_fast_rp_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| fast_rp(graph, 32, 0.5, vec![1.0, 1.0, 1.0], Some(1), None),
...
pub fn graphgen_large_max_weight_matching(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_max_weight_matching_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| max_weight_matching(graph, None, false, false),
...
pub fn graphgen_large_temporal_seir(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_temporal_seir_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| {
...
pub fn graphgen_large_temporal_bipartite_projection(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "graphgen_large_temporal_bipartite_projection_subgraph_cache_view",
        20,
        10,
        large_typed_random_attachment_subgraph_cache_view,
        |graph, _| temporal_bipartite_projection(graph, 1, "Right".to_string()),
    );
    graph_benchmark(
        c,
...
pub fn temporal_motifs(c: &mut Criterion) {
    ...
    graph_benchmark(
        c,
        "temporal_motifs_subgraph_cache_view",
        20,
        10,
        large_random_attachment_subgraph_cache_view,
        |graph, _| global_temporal_three_node_motif(graph, 100, None),
